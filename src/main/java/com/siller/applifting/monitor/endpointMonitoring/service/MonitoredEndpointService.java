...
public interface MonitoredEndpointService {
    ...
    MonitoredEndpoint updateMonitoredEndpoint(MonitoredEndpoint monitoredEndpoint, MonitoredEndpointUpdates monitoredEndpointUpdates) throws MonitoredEndpointNotFound;
